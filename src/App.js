...
class App extends Component {
  ...
  componentDidMount() {
    ...
    const requestUrl = this.props.choice === 1 ? '/api/data' : 'http://localhost4000/api/default';
      ...
      <>
        {
          this.state.loading ? (
            <div className="loading"></div>
              ...
              <>
                <Mapp cities={this.state.time_filter.length === 0 ? this.state.data : this.state.filtered_data} />
